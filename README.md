...
### Ответ:
 ...
 Не сработает фрагмент кода 1, так как сначала считывается вызов функции, а потом уже создание переменной doubleNum. 
 Другими словами: Чтение js файла происходит сверху вниз и вызов функции doubleNum происходит до её объявления.
